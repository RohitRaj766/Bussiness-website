        ...
        <div className="container">
          <div className="alert disclaimer_details " role="alert">
            ...
            <p className="lead">
              ...
              the use of Website, located at msanshugroup. By accessing
              this website we assume you accept these terms and conditions. Do
              not continue to use msanshugroup if you do not agree to
              ...
              <h3 className="py-4 text-success">Cookies</h3>
              We employ the use of cookies. By accessing msanshugroup,
              you agreed to use cookies in agreement with the MS ANSHU GROUPS's
              ...
              <h3 className="py-4 text-success">License</h3>
              Unless otherwise stated, MS ANSHU GROUPS and/or its licensors own
              the intellectual property rights for all material on
              msanshugroup. All intellectual property rights are
              reserved. You may access this from msanshugroup for your
              own personal use subjected to restrictions set in these terms and
              conditions. You must not: Republish material from
              msanshugroup Sell, rent or sub-license material from
              msanshugroup Reproduce, duplicate or copy material from
              msanshugroup Redistribute content from
              msanshugroup This Agreement shall begin on the date
              hereof. Parts of this website offer an
              opportunity for users to post and exchange opinions and
              information in certain areas of the website. MS ANSHU GROUPS does
              not filter, edit, publish or review Comments prior to their
              presence on the website. Comments do not reflect the views and
              opinions of MS ANSHU GROUPS,its agents and/or affiliates. Comments
              reflect the views and opinions of the person who post their views
              and opinions. To the extent permitted by applicable laws, MS ANSHU
              GROUPS shall not be liable for the Comments or for any liability,
              ...
              website. MS ANSHU GROUPS reserves the right to monitor all
              Comments and to remove any Comments which can be considered
              inappropriate, offensive or causes breach of these Terms and
              Conditions. You warrant and represent that: You are entitled to
              post the Comments on our website and have all necessary licenses
              ...
              trademark of any third party; The Comments will not be
              used to solicit or promote business or custom or present
              commercial activities or unlawful activity. You hereby grant MS
              ANSHU GROUPS a non-exclusive license to use, reproduce, edit and
              authorize others to use, reproduce and edit any of your Comments
              in any and all forms, formats or media.
              <h3 className="py-4 text-success">Hyperlinking to our Content</h3>
              ...
              malls, and charity fundraising groups which may not hyperlink to
              our Web site. We may consider and approve other link
              requests from the following types of organizations: commonly-known
              consumer and/or business information sources; dot.com community
              sites; associations or other groups representing charities; online
              ...
              the absence of MS ANSHU GROUPS; and (d) the link is in the context
              of general resource information. These organizations may link to
              our home page so long as the link: (a) is not in any way
              ...
              sending an e-mail to MS ANSHU GROUPS. Please include your name,
              ...
              like to link. Wait 2-3 weeks for a response. Approved
              ...
              content on the linking party’s site. No use of MS ANSHU GROUPS's
              logo or other artwork will be allowed for linking absent a
              trademark license agreement.
              <h3 className="py-4 text-success">iFrames</h3>
              Without prior approval and written permission, you may not create
              frames around our Webpages that alter in any way the visual
              presentation or appearance of our Website.
              <h3 className="py-4 text-success">Content Liability</h3>
              ...
              <h3 className="py-4 text-success">Reservation of Rights</h3>
              ...
              <h3 className="py-4 text-success">
